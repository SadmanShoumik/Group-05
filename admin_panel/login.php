...
<body>
    ...
    <div class="form-container sign-in-container">
      <form method="POST" action="login.php" class="form" id="login">
        ...
        <div class="form__input-group">
          ...
          <input type="text" class="form__input" name="uname" id="username" maxlength="20" required> 
        </div>
        <div class="form__input-group">
   ...
   <div class="overlay-container">
		<div class="overlay">
			...
			<div class="overlay-panel overlay-right">
				<h1>Hello, Friend!</h1>
				<p>Enter your personal details and start journey as an admin</p>
 ...
 <?php
    if(isset($_POST['submit'])){
        ...
        $pass=$_POST["pass"];
        echo "HI bug";
        $q="select * from admins where username='$uname' and pass='$pass';";
